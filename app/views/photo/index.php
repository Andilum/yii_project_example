...
<div class="userphoto">
    ...
    <div class="userphoto-search">
        ...
        <?= CHtml::ajaxButton(Yii::t('search', 'Найти фотографии'), Yii::app()->createUrl('/photo/index'), array(
    ...
    <?php if ($dataProvider->totalItemCount > Photo::DEFAULT_PHOTO_LIMIT_ON_PAGE): ?>
        ...
        <div class="userphoto-more">
            ...
            <?= Yii::t('search', 'Показать') ?> <?= CHtml::ajaxLink(Yii::t('search','следующие 20 фотографий'), Yii::app()->createUrl('/photo/index'), array(
