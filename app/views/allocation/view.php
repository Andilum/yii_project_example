...
$clientScript->registerScriptFile($baseUrl . '/js/Allocation/view.js');

isset($_GET['id']) ? $allocation = $allocation = DictAllocation::model()->findByPk($_GET['id']) : $allocation = null;
if ($allocation && !Yii::app()->user->isGuest): ?>
<div class="b-feedback">
    <div class="b-feedback-ttl">
        <?=Yii::t('app', 'Напишите сообщение в ленту')?>
        <a href="#"><?= $allocation->name ?> <?= $allocation->alloccat->name ?></a>
    </div>
    <?php $form = $this->beginWidget('CActiveForm', array(
        ...
        <div class="b-feedback-well">
            <div class="b-feedback-body">
                ...
                <?php echo $form->hiddenField(DictAllocation::model(),'id', array('style'=>'display: none;', 'value'=>$allocation->id)); ?>
            ...
            <div class="b-feedback-bot">
                ...
                <a class="btn bg-grey color-medium-grey" id="post-form-add-rating" href="#">
                    <i class="icon-yes"></i>
                     <?=Yii::t('app', 'ОЦЕНКУ')?>
                </a>
...
<?php endif; ?>
<?php $this->widget('PostList', array(
