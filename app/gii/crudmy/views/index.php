...
<div class="row">
		<?php echo $form->labelEx($model,'sortfiled'); ?>
		<?php echo $form->textField($model,'sortfiled',array('size'=>65)); ?>
    <div class="tooltip">
	Поля для сортировки, если нет то пусто
		</div>
		<?php echo $form->error($model,'sortfiled'); ?>
</div>
<div class="row">
		<?php echo $form->labelEx($model,'parent_fild'); ?>
		<?php echo $form->textField($model,'parent_fild',array('size'=>65)); ?>
    <div class="tooltip">
	Поля parent_id, если нет то пусто
		</div>
		<?php echo $form->error($model,'parent_fild'); ?>
</div>
