    ...
    <div class="left-scroll">
        ...
        <div class="profile">
            <table class="profile-tbl">
                <tr>
                    <td class="profile-td">
                        <a href="<?= Yii::app()->createUrl('/user/view', array('id' => Yii::app()->user->id)) ?>">
                            <img src="<?= User::getAvatarPath(Yii::app()->user->id, User::AVATAR_SIZE_50) ?>" width="60" alt="" />
                        </a>
                    </td>
                    <td class="profile-td">
                        <a class="profile-a" href="<?= Yii::app()->createUrl('/user/view', array('id' => Yii::app()->user->id)) ?>"><?=Yii::t('app', 'Мой профиль')?></a>
